...
double correlate(double const *x, double const *y, int const dimx,
                 int const dimy) {

  int i;
  double sum_sq_x, sum_sq_y, sum_coproduct, mean_x, mean_y, sweep, delta_x,
      delta_y, pop_sd_x, pop_sd_y, cov_x_y, correlation;
