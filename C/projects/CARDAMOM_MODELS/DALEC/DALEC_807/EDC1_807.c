...
int EDC1_807(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD) {
  ...
  */
  ...
  if ((EDC == 1 & DIAG == 0) || DIAG == 1 ||
    ...
    if (Pband_h2o_rz < Lband_h2o_rz) {
      allbandpass = 0;
    }
    if (Pband_h2o_ns > Lband_h2o_ns) {
      allbandpass = 0;
    }
    if (Pband_woo < Lband_woo) {
      allbandpass = 0;
    }
    if (Lband_woo < Cband_woo) {
      allbandpass = 0;
    }
    if (Lband_h2o_ns > Cband_h2o_ns) {
      allbandpass = 0;
    }
    if (Lband_fol > Cband_fol) {
      allbandpass = 0;
    }
    if (Kuband_fol < Cband_fol) {
      allbandpass = 0;
    }
