...
int PARS_INFO_1012(double *parmin, double *parmax) {
  ...
  /* 30 Resilience factor (since transfer to litter is represented as
   * (1-pars[30])) ".*/
  ...
  /* 37 jc S_fv statistically fitting the fV curves (S1,S2,S3 schemes) with
   * total soil moisture (PAW/PAW_fs)*/
  ...
  /* 43 jc v2 Imax maximum infiltration rate, mm/day same with prec, partially
   * follow Elias's hydrology */
