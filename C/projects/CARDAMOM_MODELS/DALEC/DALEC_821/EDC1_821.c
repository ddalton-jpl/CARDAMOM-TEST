...
int EDC1_821(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD) {
  ...
  */
  ...
  /* Additional EDC1 on the ratio of Jmax/Vmax for ID 821 by gquetin
   * 04/07/2020*/
  ...
  if (((EDC == 1 & DIAG == 0) || DIAG == 1 ||
      ...
      (pars[25] < pars[26] | pars[25] < pars[27])) {
    EDC = 0;
  ...
  /*Updated by G. Quetin 06.05.2021, after bug fix update to higher value of
   * Jmax per Vmax*/
  if (((EDC == 1 & DIAG == 0) || DIAG == 1 ||
       (EDC == 1 & DIAG == 2 & EDCD->SWITCH[1 - 1] == 1)) &
      ((pars[34] / pars[35] < 0.8) || (pars[34] / pars[35] > 2.2))) {
    EDC = 0;
    EDCD->PASSFAIL[17 - 1] = 0;
  }
