...
FLUX_INFO.DESCRIPTION[F.resp_auto] =
...
FLUX_INFO.DESCRIPTION[F.infil_e] =
    'INFILTRATION IE: temp = weight average of snow melt (0C) + liquid precip (@air temp)';
...
FLUX_INFO.NAME[F.ae_rh_cwd] =
    'Aerobic heterotrophic respiration coarse woody debris';
FLUX_INFO.ABBREVIATION[F.ae_rh_cwd] = 'ae_rh_cwd';
FLUX_INFO.UNITS[F.ae_rh_cwd] = 'gC/m2/day';
FLUX_INFO.DESCRIPTION[F.ae_rh_cwd] =
    'Aerobic heterotrophic respiration from coarse woody debris pool';

FLUX_INFO.NAME[F.ae_rh_lit] =
    'Aerobic heterotrophic respiration coarse woody litter';
FLUX_INFO.ABBREVIATION[F.ae_rh_lit] = 'ae_rh_lit';
FLUX_INFO.UNITS[F.ae_rh_lit] = 'gC/m2/day';
FLUX_INFO.DESCRIPTION[F.ae_rh_lit] =
    'Aerobic heterotrophic respiration from litter pool';

FLUX_INFO.NAME[F.ae_rh_som] =
    'Aerobic heterotrophic respiration soil organic matter';
FLUX_INFO.ABBREVIATION[F.ae_rh_som] = 'ae_rh_som';
FLUX_INFO.UNITS[F.ae_rh_som] = 'gC/m2/day';
FLUX_INFO.DESCRIPTION[F.ae_rh_som] =
    'Aerobic heterotrophic respiration from soil organic matter pool';

FLUX_INFO.NAME[F.an_rh_cwd] =
    'Anaerobic heterotrophic respiration coarse woody debris';
FLUX_INFO.ABBREVIATION[F.an_rh_cwd] = 'an_rh_cwd';
FLUX_INFO.UNITS[F.an_rh_cwd] = 'gC/m2/day';
FLUX_INFO.DESCRIPTION[F.an_rh_cwd] =
    'Anaerobic heterotrophic respiration from coarse woody debris pool';
...
FLUX_INFO.DESCRIPTION[F.an_rh_lit] =
    'Anaerobic heterotrophic respiration from litter pool';

FLUX_INFO.NAME[F.an_rh_som] =
    'Anaerobic heterotrophic respiration soil organic matter';
FLUX_INFO.ABBREVIATION[F.an_rh_som] = 'an_rh_som';
FLUX_INFO.UNITS[F.an_rh_som] = 'gC/m2/day';
FLUX_INFO.DESCRIPTION[F.an_rh_som] =
    'Anaerobic heterotrophic respiration from soil organic matter pool';
...
FLUX_INFO.DESCRIPTION[F.rh_co2] =
    'Total CO2 flux from heterotrophic respiration';
...
FLUX_INFO.DESCRIPTION[F.rh_ch4] =
    'Total CH4 flux from heterotrophic respiration';
...
FLUX_INFO.DESCRIPTION[F.an_co2_c_ratio] =
    'CO2 fraction in anaerobic C decomposition*';
...
FLUX_INFO.DESCRIPTION[F.an_ch4_c_ratio] =
    'CH4 fraction in anaerobic C decomposition*';
...
FLUX_INFO.DESCRIPTION[F.target_LAI] =
    'Target LAI calculated based on KNORR phenology scheme influenced by water, light, and temperature. Coded in KNORR_ALLOCATION.c';
...
FLUX_INFO.DESCRIPTION[F.dlambda_dt] =
    'Difference between Target leaf area index (target_LAI) and current leaf area index. Coded in KNORR_ALLOCATION.c ';
...
FLUX_INFO.DESCRIPTION[F.f_temp_thresh] =
    'Fraction of plants within pixel able to grow foliage on temperature threshold. Coded in KNORR_ALLOCATION.c';
...
FLUX_INFO.DESCRIPTION[F.f_dayl_thresh] =
    'Fraction of plants within pixel able to grow foliage based on daylight threshold. Coded in KNORR_ALLOCATION.c';
...
FLUX_INFO.DESCRIPTION[F.net_radiation] =
    'Net radiation flux defined as incoming shortwave radiation (SWin) - outgoing shortwave radiation (SWout) + incoming longwave radiation (LWin) - outgoing longwave radiation (LWout)';
...
FLUX_INFO.DESCRIPTION[F.resp_auto_maint] =
...
FLUX_INFO.DESCRIPTION[F.ly1xly2_th_e] =
    'Thermal conductivity between layer one and layer two*';

FLUX_INFO.NAME[F.ly2xly3_th_e] =
    'Thermal conductivity layer two to layer three*';
FLUX_INFO.ABBREVIATION[F.ly2xly3_th_e] = 'ly2xly3_th_e';
FLUX_INFO.UNITS[F.ly2xly3_th_e] = 'J/m2/day';
FLUX_INFO.DESCRIPTION[F.ly2xly3_th_e] =
    'Thermal conductivity between layer two and layer three*';

FLUX_INFO.NAME[F.resp_auto_maint_dark] =
...
FLUX_INFO.DESCRIPTION[F.resp_auto_maint_dark] =
    'Autotrophic maintenance dark respiration from foliage*';
...
FLUX_INFO.DESCRIPTION[F.geological] =
    'Prederived geological flux in J/m2/day(105mW/m2)';

FLUX_INFO.NAME[F.ets] = 'Total land-atmosphere water';
FLUX_INFO.ABBREVIATION[F.ets] = 'ets';
FLUX_INFO.UNITS[F.ets] = 'kgH2O/m2/day';
FLUX_INFO.DESCRIPTION[F.ets] =
    'Total land-atmosphere water flux (evaporation + transpiration + sublimation)';
...
FLUX_INFO.DESCRIPTION[F.beta_factor] =
    'Stress due to cold weather and water availability';
...
FLUX_INFO.DESCRIPTION[F.soil_beta_factor] =
    'Stress due to soil water availability';
...
PARS_INFO.DESCRIPTION[P.tr_lit2som] =
    'Fraction of litter lost to soil organic matter per day';
...
PARS_INFO.DESCRIPTION[P.tr_cwd2som] =
    'Fraction of course woody debris lost to soil organic matter per day';

PARS_INFO.NAME[P.rauto_mr_r] =
    'Autotrophic maintenance respiration coefficient for roots';
PARS_INFO.ABBREVIATION[P.rauto_mr_r] = 'rauto_mr_r]';
PARS_INFO.UNITS[P.rauto_mr_r] ='';
PARS_INFO.DESCRIPTION[P.rauto_mr_r] =
    'Autotrophic maintenance respiration coefficient for roots - turnover rate at 25oC (d-1)';

PARS_INFO.NAME[P.rauto_mr_w] =
    'Autotrophic maintenance respiration coefficient for wood';
PARS_INFO.ABBREVIATION[P.rauto_mr_w] = 'rauto_mr_w';
PARS_INFO.UNITS[P.rauto_mr_w] ='';
PARS_INFO.DESCRIPTION[] =
    'Autotrophic maintenance respiration coefficient for wood - turnover rate at 25oC (d-1)';

PARS_INFO.NAME[P.rauto_mr_q10] =
...
PARS_INFO.DESCRIPTION[P.rauto_mr_q10] =
    'Autotrophic maintenance respiration Q10 parameter';
...
PARS_INFO.DESCRIPTION[P.rauto_gr] =
...
PARS_INFO.DESCRIPTION[P.t_wood] =
    'Rate of wood loss per day* - 1% loss per year value';
...
PARS_INFO.DESCRIPTION[P.t_som] =
    'Rate of soil turnover to heterotrophic respiration';
...
PARS_INFO.DESCRIPTION[P.LCMA] =
    ' Leaf mass carbon per unit leaf area; Kattge et al. 2011*;*Kattge et al., provide a range of 10 400 g m-2, i.e. 5 200 gC m-2*';
...
PARS_INFO.DESCRIPTION[P.i_cwd] =
    'Size of coarse woody debris C pool at time step 1';
...
PARS_INFO.DESCRIPTION[P.i_som] =
    'Size of soil organic matter C pool at time step 1';
...
PARS_INFO.DESCRIPTION[P.resilience] =
...
PARS_INFO.DESCRIPTION[P.LY1_vhc] =
    'LY1 the change in heat content of a unit bulk volume of soil per unit change in temperature (https://www.sciencedirect.com/topics/engineering/volumetric-heat-capacity)';

PARS_INFO.NAME[P.LY2_vhc] = 'LY2 volumetric heat capacity';
PARS_INFO.ABBREVIATION[P.LY2_vhc] ='';
PARS_INFO.UNITS[P.LY2_vhc] ='';
PARS_INFO.DESCRIPTION[P.LY2_vhc] =
    'LY2 the change in heat content of a unit bulk volume of soil per unit change in temperature (https://www.sciencedirect.com/topics/engineering/volumetric-heat-capacity)';

PARS_INFO.NAME[P.LY3_vhc] = 'LY3 volumetric heat capacity';
PARS_INFO.ABBREVIATION[P.LY3_vhc] ='';
PARS_INFO.UNITS[P.LY3_vhc] ='';
PARS_INFO.DESCRIPTION[P.LY3_vhc] =
    'LY3 the change in heat content of a unit bulk volume of soil per unit change in temperature (https://www.sciencedirect.com/topics/engineering/volumetric-heat-capacity)';
...
POOLS_INFO.DESCRIPTION[S.C_lab] =
    'Stored non-structural carbohydrate (NSC) pool; also includes any structural C that is not wood, root, or leaf, e.g. flowers/fruit/seeds';
...
POOLS_INFO.DESCRIPTION[S.C_roo] =
    'Fine root carbon pool; does not include woody root biomass';

POOLS_INFO.NAME[S.C_woo] = 'Wood/ligneous carbon pool';
POOLS_INFO.ABBREVIATION[S.C_woo] = 'C_woo';
POOLS_INFO.UNITS[S.C_woo] = 'gC/m2';
POOLS_INFO.DESCRIPTION[S.C_woo] =
    'Wood/ligneous carbon pool; includes woody root biomass';
...
POOLS_INFO.DESCRIPTION[S.H2O_LY1] =
    'Bulk water content of the first belowground layer. This layer hosts shallow vegetation roots and supplies water for transpiration, evaporation, runoff, and infiltration to LY2.';
...
POOLS_INFO.DESCRIPTION[S.H2O_LY2] =
    'Bulk water content of the second belowground layer. This layer hosts deep vegetation roots and supplies water for transpiration), runoff, and infiltration to LY3.';
...
POOLS_INFO.DESCRIPTION[S.H2O_LY3] =
    'Bulk water content of the third belowground layer. This layer is inaccessible to vegetation roots, and supplies water for runoff only.';
...
POOLS_INFO.DESCRIPTION[S.D_TEMP_LY1] =
    'Temperature (K) of the first belowground layer. ';
...
POOLS_INFO.DESCRIPTION[S.D_TEMP_LY2] =
    'Temperature (K) of the second belowground layer. ';
...
POOLS_INFO.DESCRIPTION[S.D_TEMP_LY3] =
    'Temperature (K) of the third belowground layer. ';
...
POOLS_INFO.DESCRIPTION[S.D_LF_LY1] =
    'Fraction of the bulk water content existing in liquid state in the first belowground layer. ';
...
POOLS_INFO.DESCRIPTION[S.D_LF_LY2] =
    'Fraction of the bulk water content existing in liquid state in the second belowground layer. ';
...
POOLS_INFO.DESCRIPTION[S.D_LF_LY3] =
    'Fraction of the bulk water content existing in liquid state in the third belowground layer. ';

POOLS_INFO.NAME[S.D_SM_LY1] = 'Layer 1 soil moisture';
POOLS_INFO.ABBREVIATION[S.D_SM_LY1] = 'D_SM_LY1';
POOLS_INFO.UNITS[S.D_SM_LY1] =
    '((m3 H20)/(m3 total volume of pore space in soil volume)';
POOLS_INFO.DESCRIPTION[S.D_SM_LY1] =
    'Volumetric water content relative to available pore space in the first belowground layer.';

POOLS_INFO.NAME[S.D_SM_LY2] = 'Layer 2 soil moisture';
POOLS_INFO.ABBREVIATION[S.D_SM_LY2] = 'D_SM_LY2';
POOLS_INFO.UNITS[S.D_SM_LY2] =
    '((m3 H20)/(m3 total volume of pore space in soil volume)';
POOLS_INFO.DESCRIPTION[S.D_SM_LY2] =
    'Volumetric water content relative to available pore space in the second belowground layer.';

POOLS_INFO.NAME[S.D_SM_LY3] = 'Layer 3 soil moisture';
POOLS_INFO.ABBREVIATION[S.D_SM_LY3] = 'D_SM_LY3';
POOLS_INFO.UNITS[S.D_SM_LY3] =
    '((m3 H20)/(m3 total volume of pore space in soil volume)';
POOLS_INFO.DESCRIPTION[S.D_SM_LY3] =
    'Volumetric water content relative to available pore space in the third belowground layer.';
...
POOLS_INFO.DESCRIPTION[S.D_PSI_LY1] =
    'Water potential of the first belowground layer';
...
POOLS_INFO.DESCRIPTION[S.D_PSI_LY2] =
    'Water potential of the second belowground layer';
...
POOLS_INFO.DESCRIPTION[S.D_PSI_LY3] =
    'Water potential of the third belowground layer';

POOLS_INFO.NAME[S.M_LAI_MAX] =
    'Past Maximum Leaf Area Index in vegetation memory';
POOLS_INFO.ABBREVIATION[S.M_LAI_MAX] = 'M_LAI_MAX';
POOLS_INFO.UNITS[S.M_LAI_MAX] = 'm2/m2';
POOLS_INFO.DESCRIPTION[S.M_LAI_MAX] =
    'Exponentially declining term encoding vegetation \'memory\' of past water/structural limitations for LAI, to capture lagged effects of past stress.';
...
POOLS_INFO.DESCRIPTION[S.M_LAI_TEMP] =
    'Exponentially declining term encoding vegetation \'memory\' of past temperature limitations for LAI, to capture lagged effects of past stress.';
