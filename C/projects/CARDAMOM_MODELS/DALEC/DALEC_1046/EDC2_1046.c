...
int EDC2_1046(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD) {
  ...
  */
  ...
  /*litter*/
  Fin[S.C_lit] = FT[F.fol2lit] + FT[F.roo2lit] + FT[F.dx_lab2lit] +
                 FT[F.dx_fol2lit] + FT[F.dx_roo2lit];
  Fout[S.C_lit] =
      FT[F.resp_het_lit] + FT[F.lit2som] + FT[F.d_lit] + FT[F.dx_lit2som];
  /*som*/
  Fin[S.C_som] =
      FT[F.woo2som] + FT[F.lit2som] + FT[F.dx_woo2som] + FT[F.dx_lit2som];
