...
int PARS_INFO_1026(DATA *CARDADATA) {
  ...
  /*The chosen prior range in r conservatively captures the range of values by
   * Boese et al.(2017)*/
  ...
  /*r: The chosen prior range in r conservatively captures the range of values
   * by Boese et al.(2017)*/
  ...
  /*Averaging period for temperature growth trigger T (time units of model),
