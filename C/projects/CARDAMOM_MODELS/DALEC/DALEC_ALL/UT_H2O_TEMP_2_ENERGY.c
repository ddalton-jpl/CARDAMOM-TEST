...
#define DGCM_T_LIQUID_H2O_ZERO_ENERGY                                          \
  56.79 // Zero-energy temperature of super-cooled liquid water 56.79 K
...
int main() {
  ...
  LF = 0;
  TEMP = -50 + 273.15;
  U = (1 - LF) * DGCM_SPECIFIC_HEAT_ICE * TEMP +
      LF * DGCM_SPECIFIC_HEAT_WATER * (TEMP - DGCM_T_LIQUID_H2O_ZERO_ENERGY);
  // 1mm H2O at + 50C
