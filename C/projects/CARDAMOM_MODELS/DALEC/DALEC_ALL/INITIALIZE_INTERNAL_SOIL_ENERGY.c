...
double INITIALIZE_INTERNAL_SOIL_ENERGY(double internal_energy_per_mm_H2O,
                                       double H2O_mm,
                                       double dry_soil_vol_heat_capacity,
                                       double depth) {
  ...
  LY_H2O_TEMP.IN.internal_energy =
      internal_energy_per_mm_H2O; // Joules
                                  // Calculate H2O temp
  ...
  //    LY_H2O_TEMP.IN.dry_soil_vol_heat_capacity =dry_soil_vol_heat_capacity
  //    ;//J/m3/K
