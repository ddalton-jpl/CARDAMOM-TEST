...
/*unclear where this should be declared, but "pragma once" solves problem for
 * now*/

/*EDCdiagnostic structure*/
/*While this structure type is declared as part of the "DALEC" structure, should
 * include here*/
struct EDCDIAGNOSTIC {
  ...
  int SWITCH[100];
  /*EDCPROB: this term is a 0 - 1 assessment (currently qualitative) to
  determine the viability of individual EDCs*/
  double EDCPROB[100];
