...
int MODEL_INFO_1004(DATA *DATA) {
  ...
  /*"static" ensures that the memory is declared in one instance and visible to
   * all functions (I think)*/
  ...
  /*Short-term: copy quantities into DATA structure to reduce dependencies in
   * CARDAMOM_MODEL_LIBRARY.c*/
  /*Long-term: remove dependencies on DATA.nofluxes... etc. in
   * CARDAMOM_READ_BINARY_DATA and DALEC_ALL_LIKELIHOOD.c*/
  ...
  /*THESE NEED TO BE LEFT HERE UNTIL EDC_DALEC_MLF and/or EDC_DALEC_MLF_beta
   * made obsolete*/
