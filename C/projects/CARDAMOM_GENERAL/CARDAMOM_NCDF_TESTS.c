...
int main(int argc, char *files[]) {
  ...
  printf("CH4_STRUCT has uncer: %f first 3 vals are: %f %f %f",
         CARDADATA.CH4.Uncertainty, CARDADATA.CH4.values[0],
         CARDADATA.CH4.values[1], CARDADATA.CH4.values[2]);
