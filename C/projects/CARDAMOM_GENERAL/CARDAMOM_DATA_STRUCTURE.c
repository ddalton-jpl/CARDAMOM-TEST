...
typedef struct DATA {
  // This is the netCDF data struct. See CARDAMOM_NETCDF_DATA_STRUCTURE.c for
  // details on all the things contained therein
  ...
  char **parname;
  // int assemble_model;
  /*Development in progress: this structure will contain all model-specific
   * fields and memory declarations, making it therefore a flexible storage
   * field for non-global "DATA" fields*/
  void *MODEL;
