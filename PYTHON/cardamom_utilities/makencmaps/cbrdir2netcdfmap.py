...
if __name__ == "__main__":
    ...
    cutfrac = (
        0.5  # may have this labeled wrong, says how much to keep rather than throw away
    )
    ...
    plotdir = (
        MACHDIR
        + "/Google Drive/DATA/Analysis/DALEC_CMIP5/Models/erainterim/Plots/summary/"
    )

    #    dircbr = '/Users/gquetin/Google Drive/CARDAMOM_Share/SharedNotes_Experiments/ball_berry_model_tests/data/cbr/'

    dictfiles = {
        "GCRUN0": {"wildcard": dircbr_original + "*GCRUN*.cbr", "filelist": []},
        "GCRUN1": {"wildcard": dircbr + "*GCRUN*.cbr", "filelist": []},
        "GCRUN_fireclim": {"wildcard": dircbr + "*mclim_*.cbr", "filelist": []},
        "GCRUN_fireclimmod": {"wildcard": dircbr + "*mclimmod*.cbr", "filelist": []},
        "p3_uncmatch_limit_20": {
            "wildcard": dircbr + "*2001-2016_obsab_icabg_fmodis_uncmatch*.cbr"
        },
        "p2_uncmatch": {
            "wildcard": dircbr + "*2001-2016_obsmod_icabg_fmodis_uncmatch*.cbr"
        },
        "p6_smthnbe_raw": {
            "wildcard": dircbr
            + "*2001-2016_obsmod_sif20102015lai20102015nbe20102013mlaion_icabg_fmodis_uncmatch*.cbr"
        },
        "p8_uncmatch": {"wildcard": dircbr + "cruncep*.cbr"},
        "p9_uncmatch_sea10_ann20": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeunc100_10_*.cbr"
        },
        "p9_uncmatch_sea50_ann20": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeunc100_50_*.cbr"
        },
        "p9_uncmatch_sea100_ann20": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeunc100_100_*.cbr"
        },
        "p9_uncmatch_sea150_ann20": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeunc100_150_*.cbr"
        },
        "p9_uncmatch_sea200_ann20": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeunc100_200_*.cbr"
        },
        "p10_uncmatch_sea50_ann2": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeseaunc100_50_nbeannunc100_2_*.cbr"
        },
        "p10_uncmatch_sea100_ann2": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeseaunc100_100_nbeannunc100_2_*.cbr"
        },
        "p10_uncmatch_sea200_ann2": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeannunc100_2_*.cbr"
        },
        "p11_uncmatch_sea100_ann2": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_lwlaisif_1997_2016_nbeseaunc100_100_nbeannunc100_2_*.cbr"
        },
        "p12_uncmatch_sea100_ann2": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_sifnojflwlai_1997_2016_nbeseaunc100_100_nbeannunc100_2_*.cbr"
        },
        "p13_uncmatch_sea200_ann2": {
            "wildcard": dircbr
            + "cruncep001GCRUN_NOV127_20_smoothnbe_sifnojflwlai_1997_2016_nbeseaunc100_200_nbeannunc100_2_*.cbr"
        },
        "p16_long": {"wildcard": dircbr + "cru004GCR005_1920_2016_nbe2002_*.cbr"},
        "p16_long_osse": {
            "wildcard": dircbr + "cru004GCR005_1920_2016_nbe2002_ossemedian_*.cbr"
        },
        ...
        "p12_carolinebbrun": {
            "wildcard": dircbr
            + "821_cruncep001GCRUN_NOV127_20_smoothnbe_sifnojflwlai_1997_2016_nbeseaunc100_100_nbeannunc100_2_*.cbr"
        },
        ...
        "p21_luctest": {
            "wildcard": dircbr + "cru004GCR006_1920_2015_nbe2002_luc_*.cbr"
        },
    }
    ...
    INFO = {"nopars": len(pnames_org_short), "latterhalf": 0}
    ...
    for dfile in filepicklist:
        ...
        if os.path.exists(savename + ".nc"):
            ...
            dsdict[dfile] = analycbr.cbr_to_netcdf(
                fl, cutfrac=cutfrac, INFO=INFO, filesize=filesize, modelid=modelid
            )
    ...
    if "GCRUN1" in filepicklist:
        dsdict["GCRUN1_match"] = dsdict["GCRUN1"].sel(
            lat=slice(
                dsdict["GCRUN0"].lat.values.min(), dsdict["GCRUN0"].lat.values.max()
            ),
            lon=slice(
                dsdict["GCRUN0"].lon.values.min(), dsdict["GCRUN0"].lon.values.max()
            ),
        )
    ...
    if testwritebinaryflag == True:
        ...
        yesno_list = analycbr.netcdfmap_to_cbrs(
            data_set_xy, nametag=dircbrout + ftag, modelid=modelid
        )
