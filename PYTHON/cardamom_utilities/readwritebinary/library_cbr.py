...
def cbr_par_dictionary():
    ...
    """
    pardict = {
        "Decomposition rate": ("decomp_rate", "gC/m2/day"),
...
def grouped_parnames(group=None):
    ...
    turn_over_rates = ["tor_wood", "tor_root", "tor_litter", "tor_som"]

    life_span = ["leaf_lifespan", "lab_lifespan"]

    critical_params = ["decomp_rate", "q10", "canopy_eff"]

    gpp_fractions = ["fgpp_r", "fgpp_to_foliage", "fgpp_to_roots", "f_to_clab"]

    water_related = ["wilt_pt", "moisture_factor", "iwue", "runoff_fpt"]
